...
kotlin {
    ...
    swiftExport {
        moduleName = "Landlock"
        flattenPackage = "io.github.kotlinmania.landlock"
    }

    android {
        namespace = "io.github.kotlinmania.landlock"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "landlock-kotlin", version.toString())

    pom {
        name.set("landlock-kotlin")
        description.set("Kotlin Multiplatform port of landlock-lsm/rust-landlock - Landlock LSM helpers")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/landlock-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/landlock-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/landlock-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/landlock-kotlin.git")
        }
    }
}
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.landlock.codeql
