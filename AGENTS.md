...
This file is the quick-reference operating contract for landlock-kotlin. The longer
...
landlock-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`landlock`](https://crates.io/crates/landlock). Upstream Rust is the behavioral oracle while the
